...
import com.masai.dunzoclone.Adapters.ProductAdapter
import com.masai.dunzoclone.ClickLitener.ProductItemClickListener
import com.masai.dunzoclone.DataModels.ProductModel
...
class ProductActivity : AppCompatActivity(), ProductItemClickListener {
    ...
    private fun initViews() {
        ...
        btnCardBtn.setOnClickListener{
            var intent = Intent(this@ProductActivity, com.masai.dunzoclone.Activities.CartActivity::class.java)
