package com.masai.dunzoclone.Fragments
...
import com.masai.dunzoclone.Activities.*
    ...
    override fun onClick(v: View?) {
        when (v?.id) {
            ...
            R.id.ivToolbarProfile -> {
                startActivity(Intent(context, com.masai.dunzoclone.Activities.AdminActivity::class.java))
            }
            R.id.ivToolbarCart -> {
                if(cartTotalItem>0) {
                    startActivity(Intent(context, com.masai.dunzoclone.Activities.CartActivity::class.java))
                } else {
